...
ggplot(all_CMJ_incident, aes(x = Max.Concentric.RPD..N.s., fill = LB.Injury)) +
  ...
  geom_vline(xintercept = 15784.34, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 1580, y = 0.05, label = "Threshold = 15784.34", color = "#000000", hjust = 0) +
...
ggplot(all_IMTP_incident, aes(x = Peak.Vertical.Force...BM..N.kg., fill = LB.Injury)) +
  ...
  geom_vline(xintercept = 30.813, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 31, y =5, label = "Threshold = 30.813", color = "#000000", hjust = 0) +
...
#density plot
ggplot(all_IMTP_incident, aes(x = RFD...200ms..N.s., fill = LB.Injury)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 8357.859, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 8000, y =5, label = "Threshold = 8357.859", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Rate of Development 200ms (N/s)",
...
ggplot(injury_counts, aes(x = Threshold, y = n, fill = Injury)) +
  ...
  labs(
    ...
    x = "Rate of Development 200ms Threshold",
    y = "Count",
    fill = "Lower Body Injury") +
  theme_minimal()
```
