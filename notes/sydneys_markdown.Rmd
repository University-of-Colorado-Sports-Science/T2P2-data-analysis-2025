...
#4: TEST.TYPE==DJ
DJ_B <- Forcedecks_B %>%
  filter(Test.Type=="DJ")  #162 
  #select("anon_id", "Date", "Max.Jump.Height..cm.","Max.Contact.Time..s."."First.DJ.Contact.Time","DJ.Contact.Time...Difference.from.First", "Drop.Jump.Max.RSI..Flight.Time.Contact.Time.","Average.Drop.Jump.Max.RSI..Flight.Time.Contact.Time.","RSI.Modified..m.s.", "Max.RSI.Modified..m.s.", "Drop.Jump.Max.RSI..Flight.Time.Contact.Time.", "DJ.Max.RSI.Mod.VALD", )
```
...
```{r}
# density plot 
ggplot(all_nordic_incident, aes(x = strength_ratio, fill = LB.Injury)) +
  geom_density(alpha = 0.8, fill = '#CFB87C') +
  geom_vline(xintercept = 5, linetype = "dashed", color = "red", size = 1) +
  annotate("text", x = 5.1, y = 0.6, label = "Threshold = 5x Bodyweight", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Hamstring Strength Ratio",
       x = "Hamstring Strength Ratio",
       y = "Density") +
...
ggplot(injury_counts, aes(x = Threshold, y = n, fill = Injury)) +
  ...
  labs(
    ...
    x = "Hamstring Strength Threshold",
    y = "Count",
...
```{r}
#FORCEDECKS
#create a dataset containing all CMJ test data across all sports + combine w/ incidents 
all_CMJ <- rbind(CMJ_bb, CMJ_soc, CMJ_lax, CMJ_vb) 
all_CMJ_incident <- merge(all_incident, all_CMJ,by=c('anon_id'), na.rm=TRUE) #3471 v 67
#create a dataset containing all HJ test data across all sports  + combine w/ incidents
...
#create a dataset containing all IMTP test data across all sports  + combine w/ incidents
...
#create a dataset containing all SLJ test data across all sports  + combine w/ incidents
...
ggplot(all_hip_incident, aes(x = Bilateral.Hip.Abduction.Adduction.Ratio, fill = LB.Injury)) +
  ...
  annotate("text", x = 1.1, y = 2.1, label = "Threshold = 1.024", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Bilateral Hip Abduction-Adduction Ratio",
...
ggplot(all_hip_incident, aes(x = Impulse, fill = LB.Injury)) +
  ...
  annotate("text", x = 0, y = .0004, label = "Threshold=973.1775", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Impulse",
       x = "Impulse (N/s)",
       y = "Density") #+
  #scale_x_continuous(limits =c(0,3))
...
ggplot(all_hip_incident, aes(x = Hip.Abduction.MEAN.Imbalance, fill = LB.Injury)) +
  ...
  geom_vline(xintercept = 1.4, linetype = "dashed", color = "red", size = 1) +
   annotate("text", x = 1.6, y = 0.14, label = "Threshold = 1.4", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Hip Abduction Mean Imbalance",
...
ggplot(all_hip_incident, aes(x = Hip.Adduction.MEAN.Imbalance, fill = LB.Injury)) +
  ...
  geom_vline(xintercept = 4.5, linetype = "dashed", color = "red", size = 1) +
   annotate("text", x = 4.65, y = 0.13, label = "Threshold = 4.5", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Hip Adduction Mean Imbalance",
...
ggplot(all_nordic_incident, aes(x = Maximum.Nordic.Bilateral.Mean, fill = LB.Injury)) +
  ...
  geom_vline(xintercept = 301.46, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 304, y = 0.008, label = "Threshold = 301.46", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Maximum Nordic Bilateral Mean",
...
#density plot
ggplot(all_nordic_incident, aes(x = Impulse, fill = LB.Injury)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 5939.035, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 5945, y = 0.00022, label = "Threshold = 5939.035", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Impulse",
       x = "Impulse (N/s)",
       y = "Density") #+
  #scale_x_continuous(limits =c(0,35))
...
#density plot
ggplot(all_nordic_incident, aes(x = Nordic.MAX.Imbalance, fill = LB.Injury)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 10.7, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 12, y = 0.075, label = "Threshold = 10.7", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Maximum Nordic Imbalance",
       x = "Maximum Nordic Imbalance",
       y = "Density") #+
  #scale_x_continuous(limits =c(0,35))
...
ggplot(injury_counts, aes(x = Threshold, y = n, fill = Injury)) +
  ...
  scale_fill_manual(values=c("Yes"='#CFB87C',"No"='#000000'))+
  labs(
    title = "Lower Body Injury Count Above vs Below the Maximum Nordic Imbalance Threshold",
    x = "Maximum Nordic Imbalance Threshold",
    y = "Count",
    fill = "Lower Body Injury"
  ) +
  theme_minimal()
...
#density plot
ggplot(all_CMJ_incident, aes(x = Relative.Concentric.Power.Bilateral, fill = LB.Injury)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 10.3, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 11, y = 0.42, label = "Threshold = 10.3", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Relative Bilateral Concentric Power ",
       x = " Relative Bilateral Concentric Power (W/kg)",
       y = "Density") +
  scale_x_continuous(limits =c(0,18))

#count distribution
injury_counts <- all_CMJ_incident %>%
  mutate(
    Threshold = ifelse(above_threshold == 1, "Above", "Below"),
    Injury = ifelse(LB.Injury == 1, "Yes", "No")
  ) %>%
...
ggplot(injury_counts, aes(x = Threshold, y = n, fill = Injury)) +
  ...
  scale_fill_manual(values=c("Yes"='#CFB87C',"No"='#000000'))+
  labs(
    title = "Lower Body Injury Count Above vs Below the  Relative Bilateral Concentric Power Threshold",
    x = " Relative Bilateral Concentric Power Threshold",
    y = "Count",
    fill = "Lower Body Injury") +
  theme_minimal()
```
...
model <- glm(LB.Injury~ above_threshold,data=all_CMJ_incident, family="binomial")
summary(model)
odds.ratio=exp(-0.7758)
(1-odds.ratio)*100

#density plot
ggplot(all_CMJ_incident, aes(x = Eccentric.Concentric.Mean.Force.Ratio, fill = LB.Injury)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 47.7145, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 48, y = 0.1, label = "Threshold = 47.7145", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Average Eccentric Concentric Force Ratio ",
       x = "Average Eccentric Concentric Force Ratio",
       y = "Density") +
...
ggplot(injury_counts, aes(x = Threshold, y = n, fill = Injury)) +
  ...
  scale_fill_manual(values=c("Yes"='#CFB87C',"No"='#000000'))+
  labs(
    title = "Lower Body Injury Count Above vs Below the Average Eccentric Concentric Force Ratio Threshold",
    x = "Average Eccentric Concentric Force Ratio Threshold",
    y = "Count",
    fill = "Lower Body Injury") +
  theme_minimal()
```
...
#density plot
ggplot(all_CMJ_incident, aes(x = Max.Jump.Height..cm., fill = LB.Injury)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 41.379, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 30.5, y = 0.08, label = "Threshold = 41.379", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Maximum Jump Height",
...
ggplot(injury_counts, aes(x = Threshold, y = n, fill = Injury)) +
  ...
  scale_fill_manual(values=c("Yes"='#CFB87C',"No"='#000000'))+
  labs(
    title = "Lower Body Injury Count Above vs Below the Maximum Jump Height Threshold",
    x = "Maximum Jump Height Threshold",
    y = "Count",
    fill = "Lower Body Injury") +
  theme_minimal()
```
...
model <- glm(LB.Injury~ above_threshold,data=all_CMJ_incident, family="binomial")
summary(model)
odds.ratio=exp(-0.40481)
(1-odds.ratio)*100

#density plot
ggplot(all_CMJ_incident, aes(x = Max.Concentric.RPD..N.s., fill = LB.Injury)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 15784.34, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 18500, y = 0.000095, label = "Threshold = 15784.34", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Maximum Concentric RPD",
       x = "Maximum Concentric RPD (N/s)",
       y = "Density") #+
  #scale_x_continuous(limits =c(0,70))
...
ggplot(injury_counts, aes(x = Threshold, y = n, fill = Injury)) +
  ...
  scale_fill_manual(values=c("Yes"='#CFB87C',"No"='#000000'))+
  labs(
    title = "Lower Body Injury Count Above vs Below the Maximum Concentric RPD Threshold",
    x = "Maximum Concentric RPD Threshold",
    y = "Count",
    fill = "Lower Body Injury") +
  theme_minimal()
```
...
model <- glm(LB.Injury~ above_threshold,data=all_CMJ_incident, family="binomial")
summary(model)
odds.ratio=exp(-0.74619)
(1-odds.ratio)*100

#density plot
ggplot(all_CMJ_incident, aes(x = Eccentric.Mean.Braking.Force..N., fill = LB.Injury)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 783.517, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 325, y = 0.0035, label = "Threshold = 783.517", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Average Eccentric Braking Force",
       x = "Average Eccentric Braking Force (N)",
       y = "Density") +
...
ggplot(injury_counts, aes(x = Threshold, y = n, fill = Injury)) +
  ...
  scale_fill_manual(values=c("Yes"='#CFB87C',"No"='#000000'))+
  labs(
    title = "Lower Body Injury Count Above vs Below the Average Eccentric Braking Force Threshold",
    x = "Average Eccentric Braking Force Threshold",
    y = "Count",
    fill = "Lower Body Injury") +
  theme_minimal()
```
...
model <- glm(LB.Injury~ above_threshold,data=all_CMJ_incident, family="binomial")
summary(model)
odds.ratio=exp(-0.26597)
(1-odds.ratio)*100

#density plot
ggplot(all_CMJ_incident, aes(x = Max.RSI.Modified.VALD, fill = LB.Injury)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 0.3995, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 0.47, y = 3.2, label = "Threshold = 0.3995", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Maximum RSI Modified VALD",
       x = "Maximum RSI Modified VALD (m/s)",
       y = "Density") #+
  #scale_x_continuous(limits =c(0,1350))
...
ggplot(injury_counts, aes(x = Threshold, y = n, fill = Injury)) +
  ...
  scale_fill_manual(values=c("Yes"='#CFB87C',"No"='#000000'))+
  labs(
    title = "Lower Body Injury Count Above vs Below the Maximum RSI Modified VALD Threshold",
    x = "Maximum RSI Modified VALD Threshold",
    y = "Count",
    fill = "Lower Body Injury") +
  theme_minimal()
```
...
summary(model)
odds.ratio=exp(-0.24230)
(1-odds.ratio)*100

#density plot
ggplot(all_hopjump_incident, aes(x = Max.Jump.Height..cm., fill = LB.Injury)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 25.489, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 26, y = 0.082, label = "Threshold = 25.489", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Maximum Jump Height",
       x = "Maximum Jump Height (cm)",
       y = "Density") +
...
#count distribution
injury_counts <- all_hopjump_incident %>%
  mutate(
    Threshold = ifelse(above_threshold == 1, "Above", "Below"),
    Injury = ifelse(LB.Injury == 1, "Yes", "No")
  ) %>%
...
#density plot
ggplot(all_hopjump_incident, aes(x = Mean.RSI..Flight.Contact.Time., fill = LB.Injury)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 2.441, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 1.4, y = 0.08, label = "Threshold = 2.441", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Average RSI Flight Contact Time",
       x = "Average RSI Flight Contact Time (ms)",
       y = "Density") #+
  #scale_x_continuous(limits =c(0,50))
...
ggplot(injury_counts, aes(x = Threshold, y = n, fill = Injury)) +
  ...
  scale_fill_manual(values=c("Yes"='#CFB87C',"No"='#000000'))+
  labs(
    title = "Lower Body Injury Count Above vs Below the Average RSI Flight Contact Time Threshold",
    x = "Average RSI Flight Contact Time Threshold",
    y = "Count",
    fill = "Lower Body Injury") +
  theme_minimal()
```
...
model <- glm(LB.Injury~ above_threshold,data=all_hopjump_incident, family="binomial")
summary(model)
odds.ratio=exp(-0.51150)
(1-odds.ratio)*100

#density plot
ggplot(all_hopjump_incident, aes(x = Best.Contact.Time..ms., fill = LB.Injury)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 0.184, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 0.2, y =10.2, label = "Threshold = 0.184", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Best Contact Time",
...
ggplot(injury_counts, aes(x = Threshold, y = n, fill = Injury)) +
  ...
  scale_fill_manual(values=c("Yes"='#CFB87C',"No"='#000000'))+
  labs(
    title = "Lower Body Injury Count Above vs Below the Best Contact Time Threshold",
    x = "Best Contact Time Threshold",
    y = "Count",
    fill = "Lower Body Injury") +
  theme_minimal()
```
...
summary(model)
odds.ratio=exp(-0.4782)
(1-odds.ratio)*100

#density plot
ggplot(all_IMTP_incident, aes(x = Peak.Vertical.Force...BM..N.kg., fill = LB.Injury)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 30.813, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 31, y =0.007, label = "Threshold = 30.813", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Peak Vertical Force BM (N/kg)",
       x = "Peak Vertical Force BM (N/kg)",
       y = "Density") #+
  #scale_x_continuous(limits =c(0,50))

#count distribution
injury_counts <- all_IMTP_incident %>%
  mutate(
    Threshold = ifelse(above_threshold == 1, "Above", "Below"),
    Injury = ifelse(LB.Injury == 1, "Yes", "No")
  ) %>%
...
ggplot(injury_counts, aes(x = Threshold, y = n, fill = Injury)) +
  ...
  scale_fill_manual(values=c("Yes"='#CFB87C',"No"='#000000'))+
  labs(
    title = "Lower Body Injury Count Above vs Below the Peak Vertical Force Threshold",
    x = "Peak Vertical Force Threshold",
    y = "Count",
    fill = "Lower Body Injury") +
  theme_minimal()
```
...
```{r}
#trying to figure out why the density plot wont work
summary(all_IMTP_incident$RFD...200ms..N.s.)
sum(is.na(all_IMTP_incident$RFD...200ms..N.s.))
length(unique(all_IMTP_incident$RFD...200ms..N.s.))
```
...
model <- glm(LB.Injury~ above_threshold,data=all_IMTP_incident, family="binomial")
summary(model)
odds.ratio=exp(-1.26428)
(1-odds.ratio)*100

#density plot
ggplot(all_IMTP_incident, aes(x = RFD...200ms..N.s.)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 8357.859, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 4000, y =0.000099, label = "Threshold = 8357.859", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Rate of Force Development 200ms (N/s)",
       x = "Rate of Development 200ms (N/s)",
       y = "Density") #+
  #scale_x_continuous(limits =c(0,50))
...
ggplot(injury_counts, aes(x = Threshold, y = n, fill = Injury)) +
  ...
  scale_fill_manual(values=c("Yes"='#CFB87C',"No"='#000000'))+
  labs(
    title = "Lower Body Injury Count Above vs Below the Rate of Development 200ms Threshold",
    x = "Rate of Force Development 200ms Threshold",
    y = "Count",
    fill = "Lower Body Injury") +
  theme_minimal()
```
...
#density plot
ggplot(all_IMTP_incident, aes(x = Force.at.200ms...BM..N.kg.)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 24.254, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 25, y =0.06, label = "Threshold = 24.254", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Force at 200ms (N/kg)",
       x = "Force at 200ms (N/kg)",
       y = "Density") #+
  #scale_x_continuous(limits =c(0,50))
...
ggplot(injury_counts, aes(x = Threshold, y = n, fill = Injury)) +
  ...
  scale_fill_manual(values=c("Yes"='#CFB87C',"No"='#000000'))+
  labs(
    title = "Lower Body Injury Count Above vs Below the Force at 200ms Threshold",
    x = "Force at 200ms Threshold",
    y = "Count",
    fill = "Lower Body Injury") +
  theme_minimal()
```
...
#density plot
ggplot(all_IMTP_incident, aes(x = DSI)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 0.59, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 0.61, y =1.5, label = "Threshold = 0.59", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Dynamic Strength Index",
       x = "DSI",
       y = "Density") #+
  #scale_x_continuous(limits =c(0,50))
...
ggplot(injury_counts, aes(x = Threshold, y = n, fill = Injury)) +
  ...
  scale_fill_manual(values=c("Yes"='#CFB87C',"No"='#000000'))+
  labs(
    title = "Lower Body Injury Count Above vs Below the DSI Threshold",
    x = "DSI Threshold",
    y = "Count",
    fill = "Lower Body Injury") +
  theme_minimal()
...
#density plot
ggplot(all_SLJ_incident, aes(x = Max.Jump.Height..cm.)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 19.223, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 19.5, y =0.11, label = "Threshold = 19.223", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Maximum Jump Height",
       x = "Maximum Jump Height (cm)",
       y = "Density") #+
  #scale_x_continuous(limits =c(0,50))
...
#count distribution
injury_counts <- all_SLJ_incident %>%
  mutate(
    Threshold = ifelse(above_threshold == 1, "Above", "Below"),
    Injury = ifelse(LB.Injury == 1, "Yes", "No")
  ) %>%
...
#density plot
ggplot(all_SLJ_incident, aes(x = Jump.Height..Flight.Time...cm.)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 17.027, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 18, y =0.12, label = "Threshold = 17.027", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Jump Height Flight Time",
...
ggplot(injury_counts, aes(x = Threshold, y = n, fill = Injury)) +
  ...
  scale_fill_manual(values=c("Yes"='#CFB87C',"No"='#000000'))+
  labs(
    title = "Lower Body Injury Count Above vs Below the Jump Height Flight Time Threshold",
    x = "Jump Height Flight Time Threshold",
    y = "Count",
    fill = "Lower Body Injury") +
  theme_minimal()
```
...
#density plot
ggplot(all_SLJ_incident, aes(x = Landing.RFD..N.s.)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 31061.16, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 32000, y =0.00005, label = "Threshold = 31061.16", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Landing Rate of Force Development N/s",
       x = "Landing RFD (N/s)",
       y = "Density") #+
  #scale_x_continuous(limits =c(0,50))
...
ggplot(injury_counts, aes(x = Threshold, y = n, fill = Injury)) +
  ...
  scale_fill_manual(values=c("Yes"='#CFB87C',"No"='#000000'))+
  labs(
    title = "Lower Body Injury Count Above vs Below the Landing RFD Threshold",
    x = "Landing RFD Threshold",
    y = "Count",
    fill = "Lower Body Injury") +
  theme_minimal()
```
...
#density plot
ggplot(all_SLJ_incident, aes(x = Max.Concentric.Peak.Force..N.)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 1243.319, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 1250, y =0.0019, label = "Threshold = 1243.319", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Maximum Concentric Peak Force",
...
ggplot(injury_counts, aes(x = Threshold, y = n, fill = Injury)) +
  ...
  scale_fill_manual(values=c("Yes"='#CFB87C',"No"='#000000'))+
  labs(
    title = "Lower Body Injury Count Above vs Below the Maximum Concentric Peak Force Threshold",
    x = "Maximum Concentric Peak Force Threshold",
    y = "Count",
    fill = "Lower Body Injury") +
  theme_minimal()
```
...
#density plot
ggplot(all_SLJ_incident, aes(x = Concentric.Impulse..Ns.)) +
  geom_density(alpha = 0.8,fill = '#CFB87C') +
  geom_vline(xintercept = 123.136, linetype = "dashed", color = "red", size = 1) +
    annotate("text", x = 123.5, y =0.02, label = "Threshold = 123.136", color = "#000000", hjust = 0) +
  labs(title = "Density Plot: Concentric Impulse ",
...
ggplot(injury_counts, aes(x = Threshold, y = n, fill = Injury)) +
  ...
  scale_fill_manual(values=c("Yes"='#CFB87C',"No"='#000000'))+
  labs(
    title = "Lower Body Injury Count Above vs Below the Concentric Impulse Threshold",
    x = "Concentric Impulse Threshold",
    y = "Count",
    fill = "Lower Body Injury") +
  theme_minimal()
```
...
#Individual Athletes Injuries Over time
```{r}
...
ggplot(all_CMJ_incident, aes(x = Relative.Concentric.Power.Bilateral, y = Date.x)) +
  geom_point() + 
  scale_y_date(limits = as.Date(c('2023-04-08', '2025-04-18'))) +
  labs(title = 'Distribution of Relative Concentric Bilateral Power Across Sports',
       y = 'Dates',
       x = 'Relative Concentric Bilateral Power') +
  theme_bw()
...
summary(anova_result)
max(all_CMJ_incident$Concentric.Maximum.RFD..N.s.)
```
...
ggplot(all_CMJ_incident, aes(x = Max.RSI.Modified.VALD, y = Sport)) +
  ...
  theme_bw()
max(all_CMJ_incident$Max.RSI.Modified.VALD)
min(all_CMJ_incident$Max.RSI.Modified.VALD)
```
...
summary(anova_result)
mean(all_hopjump_incident$Max.Jump.Height..cm.)
max(all_hopjump_incident$Max.Jump.Height..cm.)
```
...
summary(anova_result)
max(all_hopjump_incident$Mean.RSI..Flight.Contact.Time)
```
...
summary(anova_result)
max(all_IMTP_incident$Force.at.200ms...BM..N.kg.)
```
...
summary(anova_result)
max(all_SLJ_incident$Landing.RFD..N.s.)
```
