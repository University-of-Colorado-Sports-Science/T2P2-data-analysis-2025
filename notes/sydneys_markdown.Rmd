...
summary(cp)
```
For Concentric Impulse the optimal cutpoint is 19.223 with a AUC of 0.6147, sensitivity of 0.3625 and specificity of 0.8889.
...
text(1 - best_coords["specificity"], best_coords["sensitivity"],
     labels = paste("Threshold =", round(best_coords["threshold"], 2)), pos = 4)
```
For Concentric Impulse the optimal threshold is 24.953 with a AUC of 0.3853 , sensitivity of 0.9897172 and specificity of 0.02777778.   

```{r}
#look at/discover/create more meaningful thresholds for strength metrics relating to LB injury risk, then test confirm threshold is valuable + interpret
all_SLJ_incident <-  all_SLJ_incident %>%
  mutate(above_threshold=ifelse(Concentric.Impulse..Ns.>= 19.223, 1,0))#add newfound threshold
