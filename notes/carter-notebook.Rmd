...
b <- b %>%
  ...
  group_by(anon_id, Date) %>%
  summarise(Countermovement.Depth..cm.= mean(Countermovement.Depth..cm., na.rm=TRUE),
            Peak.Power...BM..W.kg.= mean(Peak.Power...BM..W.kg., na.rm=TRUE),
            Landing.RFD..N.s.= mean(Landing.RFD..N.s.,na.rm=TRUE),
            Eccentric.Concentric.Mean.Force.Ratio= mean(Eccentric.Concentric.Mean.Force.Ratio,na.rm=TRUE),
            Peak.Landing.Force..Asym...N.= mean(Peak.Landing.Force..Asym...N.,na.rm=TRUE),
            Peak.Power..W.= mean(Peak.Power..W.,na.rm=TRUE),
            Concentric.RFD..N.s.= mean(Concentric.RFD..N.s.,na.rm=TRUE),
            Concentric.RFD..Left...N.s.= mean(Concentric.RFD..Left...N.s.,na.rm=TRUE),
            Concentric.RFD..Right...N.s.= mean(Concentric.RFD..Right...N.s.,na.rm=TRUE),
            Eccentric.Mean.Braking.Force..N.= mean(Eccentric.Mean.Braking.Force..N.,na.rm=TRUE),
            Concentric.Time.to.Peak.Force..s.= mean(Concentric.Time.to.Peak.Force..s.,na.rm=TRUE),
            Landing.Net.Peak.Force...BM..N.kg.= mean(Landing.Net.Peak.Force...BM..N.kg.,na.rm=TRUE),
            Peak.Net.Takeoff.Force...BM..N.kg.= mean(Peak.Net.Takeoff.Force...BM..N.kg.,na.rm=TRUE),
            Concentric.RPD...BM..W.s.kg.= mean(Concentric.RPD...BM..W.s.kg.,na.rm=TRUE),
            Force.at.Peak.Power..N.= mean(Force.at.Peak.Power..N.,na.rm=TRUE),
            Eccentric.Mean.Deceleration.Force..N.= mean(Eccentric.Mean.Deceleration.Force..N.,na.rm=TRUE),
            Eccentric.Peak.Force..N.= mean(Eccentric.Peak.Force..N.,na.rm=TRUE),
            RSI.Modified..m.s.= mean(RSI.Modified..m.s.,na.rm=TRUE),
            CMJ.Stiffness..Left...N.m.= mean(CMJ.Stiffness..Left...N.m.,na.rm=TRUE),
            CMJ.Stiffness..Right...N.m.= mean(CMJ.Stiffness..Right...N.m.,na.rm=TRUE),
            Eccentric.Asymmetry= get_mode(Eccentric.Asymmetry),
            Concentric.Asymmetry= get_mode(Concentric.Asymmetry),
            Peak.Landing.Asymmetry= get_mode(Peak.Landing.Asymmetry),
            DSI = mean(DSI,na.rm=TRUE),
            DSI.Bucket = get_mode(DSI.Bucket),
            .groups = 'drop') %>%
...
HJ_B <- Forcedecks_B %>%
  ...
  dplyr::select("anon_id", "Date", "Corrected.Standing.Weight..Kg.", "Mean.RSI..Flight.Contact.Time.", "Active.Stiffness..N.m.", "Best.Average.Force..N.", "Best.Average.Force..Asym...N.", "Best.Time.to.Peak.Force..ms.", "Best.Contact.Time..ms.", "Best.Flight.Time..ms.", "Best.Impulse..N.s.", "Best.Peak.Force..N.", "Best.Peak.Force..Asym...N.", "Mean.Average.Force..N.", "Mean.Average.Force..Asym...N.", "Mean.Landing.RFD..N.s.", "Mean.Landing.RFD..Asym...N.s.", "Stiffness.Fatigue....", "Stiffness.Fatigue..Asym.....", "Max.Jump.Height..cm.", "HJ.RSI") %>%
  mutate(Date = as.Date(Date, format = '%m/%d/%Y')) %>%
  na.omit() %>%
  mutate(Sport = 'Basketball')
                 #409 obs & 20 vars
...
merge_hj_B <- merge_hj_B %>%
  ...
  mutate(Was.Injured = ifelse(Group == 1 | Group == 2 | Group == 3, 'Yes', Group)) %>%
  dplyr::select(anon_id, Date, Corrected.Standing.Weight..Kg., Mean.RSI..Flight.Contact.Time., Active.Stiffness..N.m., Best.Average.Force..N., Best.Average.Force..Asym...N., Best.Time.to.Peak.Force..ms., Best.Contact.Time..ms., Best.Flight.Time..ms., Best.Impulse..N.s., Best.Peak.Force..N., Best.Peak.Force..Asym...N., Mean.Average.Force..N., Mean.Average.Force..Asym...N., Mean.Landing.RFD..N.s., Mean.Landing.RFD..Asym...N.s., Stiffness.Fatigue...., Stiffness.Fatigue..Asym....., Max.Jump.Height..cm., Injury, Mechanism, Was.Injured, Sport, HJ.RSI)
```
...
merge_imtp_B <- merge_imtp_B %>%
  ...
  mutate(Was.Injured = ifelse(Group == 1 | Group == 2 | Group == 3, 'Yes', Group)) %>%
  dplyr::select(anon_id, Date, Baseline.Force..N., Baseline.Force..Asym...N., Peak.Vertical.Force..N., Peak.Vertical.Force...BM..N.kg., Peak.Vertical.Force..Asym...N., RFD...50ms..N.s., RFD...50ms..Asym...N.s., RFD...100ms..N.s., RFD...100ms..Asym...N.s., RFD...150ms..N.s., RFD...150ms..Asym...N.s., RFD...200ms..N.s., RFD...200ms..Asym...N.s., Net.Peak.Vertical.Force..N.s., Net.Peak.Vertical.Force..Asym...N.s., Force.at.200ms...BM..N.kg., Absolute.Impulse.50ms..Ns., Absolute.Impulse.50ms..Asym...Ns., Absolute.Impulse.100ms..Ns., Absolute.Impulse.100ms..Asym...Ns., Absolute.Impulse.150ms..Ns., Absolute.Impulse.150ms..Asym...Ns., Absolute.Impulse.200ms..Ns., Absolute.Impulse.200ms..Asym...Ns., Injury, Mechanism, Was.Injured, Sport)
```
...
merge_performance_S <- merge_performance_S %>%
  ...
  Mechanism = case_when(
    ...
    Group == 3 ~ Injury.3.Mech,
    Group == 4 ~ Injury.4.Mech,
    Group == 5 ~ Injury.1.Mech,
    Group == 6 ~ Injury.2.Mech,
    Group == 7 ~ Injury.3.Mech,
    TRUE ~ 'After'
  )) %>%
...
performance_all_injury %>%
  group_by(Mechanism) %>%
  summarize(`Relative Max Bilateral Force` = mean(Relative.Maximum.Nordic.Bilateral.Mean),
            `Max Bilateral Force` = mean(Maximum.Nordic.Bilateral.Mean),
            `Percent Diff Norm` = mean(Force.Diff.Norm),
            `Imbalance` = mean(Nordic.MEAN.Imbalance),
            `Trend` = mean(Trend),
...
ggplot(data = performance_all_injury, aes(Maximum.Nordic.Bilateral.Mean, fill = Was.Injured)) + 
  geom_density(alpha = 0.5) +
  scale_fill_manual(values = c('#CFB87C', '#000000')) +
...
hip_all_injury %>%
  group_by(Mechanism) %>%
  summarize(`Average Abduction Mean` = mean(Avg.Abd.Mean),
            `Average Abduction Max` = mean(Avg.Abd.Max),
            `Average Adduction Mean` = mean(Avg.Add.Mean),
            `Average Adduction Max` = mean(Avg.Add.Max),
            `Relative Abduction Mean` = mean(Relative.Abd.Mean),
            `Relative Abduction Max` = mean(Relative.Abd.Max),
            `Relative Adduction Mean` = mean(Relative.Add.Mean),
            `Relative Adduction Max` = mean(Relative.Add.Max))
```

```{r}
ggplot(data = hip_all_injury, aes(Avg.Add.Mean, fill = Mechanism)) + 
  geom_density(alpha = 0.5) +
#  scale_fill_manual(values = c('#CFB87C', '#000000')) +
...
cmj_all_injury %>%
  group_by(Mechanism) %>%
  summarize(`Depth` = mean(Countermovement.Depth..cm.),
            `Peak Power w/ BW` = mean(Peak.Power...BM..W.kg.),
            `Peak Power` = mean(Peak.Power..W.),
            `E/C Ratio` = mean(Eccentric.Concentric.Mean.Force.Ratio),
            `C Time to Peak` = mean(Concentric.Time.to.Peak.Force..s.),
            `Peak Net Takeoff` = mean(Peak.Net.Takeoff.Force...BM..N.kg.),
            `DSI` = mean(DSI))
```
...
```{r}
ggplot(data = cmj_all_injury, aes(DSI, fill = Was.Injured)) + 
  geom_density(alpha = 0.5) +
  scale_fill_manual(values = c('#CFB87C', '#000000')) +
  ...
  facet_wrap(~Sport) + 
  geom_vline(xintercept = 0.665, color = 'red', linetype = 'dashed') +
  theme_bw()
```
...
```{r}
ggplot(data = hj_all_injury %>% filter(Sport!='Volleyball'), aes(Best.Impulse..N.s., fill = Was.Injured)) + 
  geom_density(alpha = 0.5) +
  scale_fill_manual(values = c('#CFB87C', '#000000')) +
  labs(title = 'Siffness Fatigue Asymmetry vs Lower Body Injury',
       x = 'Stiffness Fatigue Asymmetry',
       y = 'Density',
       fill = 'Lower Body Injury') +
  facet_wrap(~Sport) +
  theme_bw()
...
ggplot(cmj, aes(x = Force.at.Peak.Power..N., color = Sport, fill = Sport)) + 
  geom_density(alpha = 0.4) + 
  scale_fill_manual(values = c('#CFB87C', '#666666', '#000000', '#8C7853')) +
  scale_color_manual(values = c('#CFB87C', '#666666', '#000000', '#8C7853')) +
  labs(title = 'Distribution of Force at Peak Power Across Sports',
...
```{r}
#creates a density plot for maximum force across sports
ggplot(cmj, aes(x = Force.at.Peak.Power..N., color = Sport.2, fill = Sport.2)) + 
  geom_density(alpha = 0.5) + 
  scale_fill_manual(values = c('#CFB87C', '#000000')) +
...
```{r}
#creates a density plot for maximum force across sports
ggplot(hj, aes(x = Max.Jump.Height..cm., color = Sport, fill = Sport)) + 
  geom_density(alpha = 0.4) + 
  scale_fill_manual(values = c('#CFB87C', '#666666', '#000000', '#8C7853')) +
  scale_color_manual(values = c('#CFB87C', '#666666', '#000000', '#8C7853')) +
  labs(title = 'Distribution of Best Impulse Hop Jump Across Sports',
       x = 'Best Impulse (N/s)',
       y = 'Density') +
  theme_bw()
```
...
```{r}
#creates a density plot for maximum force across sports
ggplot(hj, aes(x = Best.Impulse..N.s., color = Sport.2, fill = Sport.2)) + 
  geom_density(alpha = 0.5) + 
  scale_fill_manual(values = c('#CFB87C', '#000000')) +
  scale_color_manual(values = c('#CFB87C', '#000000')) +
  labs(title = 'Distribution of Best Impulse Hop Jump Across Sports',
...
```{r}
t.test(Max.Jump.Height..cm. ~ Sport, data = hj %>% filter(Sport %in% c('Basketball', 'Volleyball')))
```
...
```{r}
#creates a density plot for maximum force across sports
ggplot(performance_all_nordic, aes(x = Nordic.MEAN.Imbalance, color = Sport, fill = Sport)) + 
  geom_density(alpha = 0.4) + 
  scale_fill_manual(values = c('#CFB87C', '#666666', '#000000', '#8C7853')) +
  scale_color_manual(values = c('#CFB87C', '#666666', '#000000', '#8C7853')) +
  labs(title = 'Distribution of Mean Imbalance Across Sports',
       x = 'Mean Imbalance',
       y = 'Density') +
  theme_bw()
```
...
ggplot(performance_all_nordic, aes(x = Nordic.MEAN.Imbalance, color = Sport.2, fill = Sport.2)) + 
  geom_density(alpha = 0.5) + 
  scale_fill_manual(values = c('#CFB87C', '#000000')) +
  scale_color_manual(values = c('#CFB87C', '#000000')) +
  labs(title = 'Distribution of Mean Imbalance Across Sports',
